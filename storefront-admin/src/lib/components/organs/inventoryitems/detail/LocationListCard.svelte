<script lang="ts">
	...
	let {
		...
		actionLabel,
		onActionClick,
		showManageLocationsSheet = false,
		manageLocationsSheetOpen = $bindable(false),
		...
		actionLabel?: string;
		onActionClick?: () => void;
		showManageLocationsSheet?: boolean;
		manageLocationsSheetOpen?: boolean;
