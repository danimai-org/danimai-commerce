								...
								<SidebarMenu>
									...
									<SidebarMenuItem>
										<SidebarMenuButton
											...
											onclick={() => goto(resolve('/sales-channels', {}), {})}
										>
											<Store />
												...
												{#snippet child({ props: triggerProps })}
													<SidebarMenuButton
														...
														isActive={path.startsWith('/inventory') ||
															path.startsWith('/inventoryitems')}
											...
											<Collapsible.Trigger>
												{#snippet child({ props: triggerProps })}
													<SidebarMenuButton
														...
														tooltipContent="Manage 	Promotions"
													>
														<BadgePercent />
									...
									<SidebarMenuItem>
										<SidebarMenuButton
											...
											onclick={() => goto(resolve('/price-lists', {}), {})}
										>
											<DollarSign />
										...
										<Collapsible.Root bind:open={rolesPermissionsOpen} class="group/collapsible">
											<Collapsible.Trigger>
												{#snippet child({ props: triggerProps })}
													<SidebarMenuButton
														{...triggerProps}
														isActive={path.startsWith('/users')}
											...
											<Collapsible.Content>
												<SidebarMenuSub>
													<SidebarMenuSubItem>
														<SidebarMenuSubButton
															href="/users"
															isActive={path === '/users' || path === '/users/'}
														>
															Users
														</SidebarMenuSubButton>
													</SidebarMenuSubItem>
													<SidebarMenuSubItem>
														<SidebarMenuSubButton
															href="/users/roles"
															isActive={path.startsWith('/users/roles')}
														>
															Roles
														</SidebarMenuSubButton>
													</SidebarMenuSubItem>
													<SidebarMenuSubItem>
														<SidebarMenuSubButton
															...
															isActive={path.startsWith('/users/permissions')}
														>
															Permissions
														</SidebarMenuSubButton>
													</SidebarMenuSubItem>
													<SidebarMenuSubItem>
														<SidebarMenuSubButton
															href="/users/invites"
															isActive={path.startsWith('/users/invites')}
														>
															Invites
														</SidebarMenuSubButton>
													</SidebarMenuSubItem>
									...
									<SidebarMenuItem>
										<SidebarMenuButton
											isActive={path === '/settings' || path === '/settings/'}
