    ...
    <div class="address-modal-root" role="presentation">
        ...
        >
            ...
            <form class="address-modal__form" onsubmit={handleSubmit}>
                ...
                <label
                    class="address-field address-field--full address-field--phone"
                >
                    <span class="address-phone-prefix" aria-hidden="true"
                        >+91</span
                    >
                    <input
                        bind:value={phone}
                ...
                <label class="address-default">
                    ...
                    <span class="address-default__box" aria-hidden="true"
                    ></span>
