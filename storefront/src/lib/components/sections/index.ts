...
export { default as ProductGridSection } from '$lib/components/sections/ProductGridSection.svelte';
...
export { default as AboutPartnersSection } from '$lib/components/sections/AboutPartnersSection.svelte';
export { default as AboutPrinciplesSection } from '$lib/components/sections/AboutPrinciplesSection.svelte';
