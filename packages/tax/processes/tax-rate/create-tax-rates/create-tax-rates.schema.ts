...
export const CreateTaxRatesResponseSchema = Type.Array(TaxRateResponseSchema);
export type CreateTaxRatesProcessOutput = Static<
  typeof CreateTaxRatesResponseSchema
>;
