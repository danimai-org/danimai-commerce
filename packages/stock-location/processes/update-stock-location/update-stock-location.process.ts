...
import {
  ...
  type UpdateStockLocationProcessOutput,
  UpdateStockLocationSchema,
} from "./update-stock-location.schema";
import type { Database } from "../../db/type";

/**
 * Handles the update stock location process.
 * Input: validated process context input for this operation.
 * Output: process-specific result data for downstream callers.
 */
export const UPDATE_STOCK_LOCATION_PROCESS = Symbol("UpdateStockLocation");

@Process(UPDATE_STOCK_LOCATION_PROCESS)
export class UpdateStockLocationProcess
  implements
    ProcessContract<
      typeof UpdateStockLocationSchema,
      UpdateStockLocationProcessOutput
    >
{
  constructor(
    @InjectDB()
