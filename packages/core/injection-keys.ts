...
export const DANIMAI_CONTEXT = Symbol("DANIMAI_CONTEXT");
export const DANIMAI_INITIALIZED = Symbol("DANIMAI_INITIALIZED");
export const DANIMAI_EMAIL = Symbol("DANIMAI_EMAIL");
