...
import {
  ...
  type RetrieveProductProcessOutput,
} from "./retrieve-product.schema";
...
export class RetrieveProductProcess implements ProcessContract<
  typeof RetrieveProductSchema,
  RetrieveProductProcessOutput
> {
  constructor(
    @InjectDB()
  ...
  async runOperations(
    ...
    const product = await this.db
      ...
      .leftJoin(
        ...
        "product_tag_relations.product_id",
        "products.id",
      )
    ...
    return { ...product, thumbnail, media };
  }
}
