...
export const CreateProductAttributeResponseSchema = Type.Union([
  ProductAttributeResponseSchema,
  Type.Undefined(),
]);
export type CreateProductAttributeProcessOutput = Static<
  typeof CreateProductAttributeResponseSchema
>;
